...
class GKTemplateLayout {
    ...
    public function generateLayout($offset) {
    	...
    	$this->API->addCSS($this->API->URLtemplate() . '/css/tablet.css','text/css','only screen and (max-width: '.$min_content_width.'px), only screen and (max-device-width: '.$min_content_width.'px) and (-moz-max-device-pixel-ratio: 1.5), only screen and (max-device-width: '.$min_content_width.'px) and (-o-max-device-pixel-ratio: 1.5/1), only screen  and (max-device-width: '.$min_content_width.'px) and (-webkit-max-device-pixel-ratio: 1.5), only screen and (max-device-width: '.$min_content_width.'px) and (max-device-pixel-ratio: 1.5), only screen and (max-device-width: '.($min_content_width * 2).'px) and (-moz-min-device-pixel-ratio: 2), only screen and (max-device-width: '.($min_content_width * 2).'px) and (-o-min-device-pixel-ratio: 2/1), only screen and (max-device-width: '.($min_content_width * 2).'px) and (-webkit-min-device-pixel-ratio: 2), only screen and (max-device-width: '.($min_content_width * 2).'px) and (min-device-pixel-ratio: 2)');
