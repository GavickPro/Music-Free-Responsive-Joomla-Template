...
class JFormFieldSidebarWidthOverride extends JFormField
{
	...
	protected function getInput() {		
		...
		$html .= '<div class="input-prepend"><input type="text" value="" id="sidebar_width_for_pages_select" /><span class="add-on">%</span>';
		$html .= '<input class="btn" type="button" value="'.JText::_('TPL_GK_LANG_ADD_RULE').'" id="sidebar_width_for_pages_add_btn" /></div>';
